...
function testButtonClicks() {
  ...
  if (generateBtn) {
    ...
    setTimeout(() => {
      const toasts = document.querySelectorAll('[data-hot-toast], [role="alert"], .toast');
...
function testReactEvents() {
  ...
  if (window.__REACT_DEVTOOLS_GLOBAL_HOOK__) {
    ...
    console.log('❌ React DevTools not found - this might indicate React isn\'t loading properly');
  }
