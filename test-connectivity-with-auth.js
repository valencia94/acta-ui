...
console.log(
  "   → This test requires running in browser with actual Cognito auth",
);
console.log(
  "   → Use the browser test runner instead: public/button-test-runner.html",
);
console.log(
  "   → Or test manually by logging in as christian.valencia@ikusi.com",
);
console.log("");
