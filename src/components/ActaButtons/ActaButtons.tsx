      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full">
        ...
        <Button
          ...
          className="
            ...
            text-white font-semibold px-4 sm:px-5 py-3 rounded-xl
      ...
      <div className="grid grid-cols-3 gap-2 w-full mt-3">
        <Button
          ...
          className="
            ...
            text-green-700 hover:text-green-800 font-medium px-2 sm:px-3 py-2.5 rounded-lg
            transition-all duration-300 ease-out
            focus:outline-none focus:ring-2 focus:ring-green-300 focus:ring-offset-2
        ...
        <Button
          ...
          className="
            ...
            text-blue-700 hover:text-blue-800 font-medium px-2 sm:px-3 py-2.5 rounded-lg
            transition-all duration-300 ease-out
        ...
        <Button
          ...
          className="
            ...
            text-teal-700 hover:text-teal-800 font-medium px-2 sm:px-3 py-2.5 rounded-lg
            transition-all duration-300 ease-out
            focus:outline-none focus:ring-2 focus:ring-teal-300 focus:ring-offset-2
            disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:border-gray-200 disabled:text-gray-400
            shadow-md hover:shadow-lg hover:-translate-y-0.5
