...
export const counterDefaultValue = import.meta.env.VITE_COUNTER ? +import.meta.env.VITE_COUNTER : 0;
...
export const skipAuth = import.meta.env.DEV && import.meta.env.VITE_SKIP_AUTH === 'true';
...
export const cognitoPoolId = import.meta.env.VITE_COGNITO_POOL_ID || 'us-east-2_FyHLtOhiY';
...
export const cognitoDomain =
  import.meta.env.VITE_COGNITO_DOMAIN || 'us-east-2-fyhltohiy.auth.us-east-2.amazoncognito.com';
...
export const appDomain = import.meta.env.VITE_APP_DOMAIN || 'd7t9x3j66yd8k.cloudfront.net';

// Application Configuration
export const appName = import.meta.env.VITE_APP_NAME || 'Ikusi · Acta Platform';

// Mock/Sample Data Control
// Only use mock data in development when explicitly enabled
export const useMockData = import.meta.env.DEV && import.meta.env.VITE_USE_MOCK === 'true';

export const ffmpegPath = import.meta.env.FFMPEG_PATH || './bin/ffmpeg';

// Monitoring
export const cloudwatchPolicyId = import.meta.env.CLOUDWATCH_POLICY_ID || 'WDnzkPmx3dKaEAQgFKx2jj';
