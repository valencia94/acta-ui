...
describe('aws parity', () => {
  ...
  it('should have correct identity pool ID', () => {
    expect(cfg.Auth.identityPoolId).toBe('us-east-2:1d50fa9e-c72f-4a3d-acfd-7b36ea065f35');
  });

  it('should have correct API endpoint with /prod path', () => {
    expect(cfg.API.REST.ActaAPI.endpoint).toBe('https://q2b9avfwv5.execute-api.us-east-2.amazonaws.com/prod');
  });
