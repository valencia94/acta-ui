import { r as _a } from "./chunk-D8vxuQkl.js";
var Co = { exports: {} },
  ve = {},
  xo = { exports: {} },
  _o = {};
...
function Ma(e, n, t, r) {
  if (n === null || typeof n > "u" || La(e, n, t, r)) return !0;
  if (r) return !1;
  if (t !== null)
    switch (t.type) {
      case 3:
...
function Pu(e, n, t, r) {
  ...
  (l !== null
    ...
    (Ma(n, t, l, r) && (t = null),
    r || l === null
      ? Ta(n) && (t === null ? e.removeAttribute(n) : e.setAttribute(n, "" + t))
      : l.mustUseProperty
...
function Va(e, n, t, r, l, u, i, o, s) {
  ((gt = !1), (Er = null), ja.apply(Ua, arguments));
}
function Aa(e, n, t, r, l, u, i, o, s) {
  if ((Va.apply(this, arguments), gt)) {
    if (gt) {
      var d = Er;
      ((gt = !1), (Er = null));
...
var Ko = me.unstable_scheduleCallback,
  ...
  Ha = me.unstable_shouldYield,
  Qa = me.unstable_requestPaint,
  Q = me.unstable_now,
  Wa = me.unstable_getCurrentPriorityLevel,
  Ru = me.unstable_ImmediatePriority,
  Yo = me.unstable_UserBlockingPriority,
  xr = me.unstable_NormalPriority,
  $a = me.unstable_LowPriority,
...
var Pe = Math.clz32 ? Math.clz32 : Ga,
  Ya = Math.log,
  Xa = Math.LN2;
function Ga(e) {
...
function ef(e, n, t, r, l) {
  switch (n) {
    ...
    case "gotpointercapture":
      return (
        (u = l.pointerId),
        Lt.set(u, ot(Lt.get(u) || null, e, n, t, r, l)),
        !0
      );
  }
  return !1;
...
function cr(e) {
  ...
  for (var n = e.targetContainers; 0 < n.length; ) {
    ...
    } else return ((n = $t(t)), n !== null && Fu(n), (e.blockedOn = t), !1);
    n.shift();
  }
  return !0;
}
...
function st(e, n) {
  e.blockedOn === n &&
    ...
    Jl ||
      ((Jl = !0),
      me.unstable_scheduleCallback(me.unstable_NormalPriority, nf)));
}
function Mt(e) {
  function n(l) {
    return st(l, e);
...
function Iu(e, n, t, r) {
  if (Nr) {
    ...
    else if ((zi(e, r), n & 4 && -1 < ba.indexOf(e))) {
      for (; l !== null; ) {
        var u = $t(l);
        if (
          (u !== null && Jo(u),
...
var nt = {
  ...
  Li = he(Kr),
  uf = V({}, Kr, { dataTransfer: 0 }),
  of = he(uf),
  sf = V({}, Wt, { relatedTarget: 0 }),
  hl = he(sf),
  af = V({}, nt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  ff = he(af),
  cf = V({}, nt, {
...
var gf = V({}, Wt, {
  ...
  Ef = he(Sf),
  Cf = V({}, nt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  xf = he(Cf),
  _f = V({}, Kr, {
    deltaX: function (e) {
...
var Pf = Be && "TextEvent" in window && !wt,
...
var Le = typeof Object.is == "function" ? Object.is : Uf;
function Rt(e, n) {
  if (Le(e, n)) return !0;
...
var Af = Be && "documentMode" in document && 11 >= document.documentMode,
  Rn = null,
  bl = null,
  St = null,
  eu = !1;
...
for (var kl = 0; kl < Bi.length; kl++) {
  var Sl = Bi[kl],
    Bf = Sl.toLowerCase(),
    Hf = Sl[0].toUpperCase() + Sl.slice(1);
  fn(Bf, "on" + Hf);
}
...
var ht =
  ...
  Qf = new Set("cancel close invalid load scroll toggle".split(" ").concat(ht));
function Hi(e, n, t) {
  ...
  if (!e[rr]) {
    ((e[rr] = !0),
      No.forEach(function (t) {
        t !== "selectionchange" && (Qf.has(t) || El(t, !1, e), El(t, !0, e));
      }));
        ...
        for (var a = d, c; a !== null; ) {
          ...
          if (
            (c.tag === 5 &&
              h !== null &&
              ((c = h),
              f !== null && ((h = Pt(a, f)), h != null && k.push(Ft(a, h, c)))),
            F)
          )
            break;
          a = a.return;
...
function Pr(e, n) {
  for (var t = n + "Capture", r = []; e !== null; ) {
    ...
    (l.tag === 5 &&
      ...
      ((l = u),
      (u = Pt(e, t)),
      u != null && r.unshift(Ft(e, u, l)),
      (u = Pt(e, n)),
      u != null && r.push(Ft(e, u, l))),
      (e = e.return));
  }
  return r;
}
...
function Qi(e, n, t, r, l) {
  for (var u = n._reactName, i = []; t !== null && t !== r; ) {
    ...
    (o.tag === 5 &&
      ...
      ((o = d),
      l
        ? ((s = Pt(t, u)), s != null && i.unshift(Ft(t, s, o)))
        : l || ((s = Pt(t, u)), s != null && i.push(Ft(t, s, o)))),
      (t = t.return));
  }
...
var tt = Math.random().toString(36).slice(2),
  ...
  uu = "__reactEvents$" + tt,
  Gf = "__reactListeners$" + tt,
  Zf = "__reactHandles$" + tt;
function yn(e) {
  var n = e[Re];
  if (n) return n;
...
function ks(e, n, t) {
  ...
  if (((n = n.childContextTypes), typeof r.getChildContext != "function"))
    return t;
  r = r.getChildContext();
  for (var l in r) if (!(l in n)) throw Error(y(108, Ra(e) || "Unknown", l));
  return V({}, t, r);
}
function Mr(e) {
  return (
...
function ei(e, n, t, r, l, u) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (vr.current = e === null || e.memoizedState === null ? rc : lc),
    (e = t(r, l)),
    Et)
  ) {
    u = 0;
...
var Vr = {
  ...
  rc = {
    ...
    useTransition: function () {
      var e = eo(!1),
        n = e[0];
      return ((e = ec.bind(null, e[1])), (De().memoizedState = e), [n, e]);
    },
    ...
    return n.flags & 256
      ...
      : n.memoizedState !== null
        ...
        : ((u = r.fallback),
          ...
          (r.sibling = u),
          (n.child = r),
          (n.mode & 1) !== 0 && Jn(n, e.child, null, i),
  ...
  switch ((Qu(n), n.tag)) {
              ...
              if (o.hasOwnProperty(u)) {
                ...
                u === "style"
                  ...
                  : u === "dangerouslySetInnerHTML"
                    ? ((s = s ? s.__html : void 0), s != null && Fo(e, s))
                    : u === "children"
                      ? typeof s == "string"
                        ? (t !== "textarea" || s !== "") && zt(e, s)
    ...
    case 13:
      if (
        ...
        if (I && de !== null && (n.mode & 1) !== 0 && (n.flags & 128) === 0)
    ...
    case 17:
      return (ae(n.type) && Lr(), ee(n), null);
    case 19:
      if ((O(j), (u = n.memoizedState), u === null)) return (ee(n), null);
...
function oa(e) {
  ...
  (n !== null && ((e.alternate = null), oa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Re], delete n[It], delete n[uu], delete n[Gf], delete n[Zf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function fe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Ni(t), n === 1))
      (e.tag === 0 ? Jf(wo.bind(null, e)) : Ss(wo.bind(null, e)),
        Yf(function () {
          (L & 6) === 0 && dn();
        }),
        (t = null));
...
function hn(e, n, t) {
  var r = M,
    l = ke.transition;
  try {
    ((ke.transition = null), (M = 1), wc(e, n, t, r));
  } finally {
    ((ke.transition = l), (M = r));
  }
  return null;
...
function ya(e, n) {
  n === 0 &&
    ((e.mode & 1) === 0
      ? (n = 1)
      : ((n = bt), (bt <<= 1), (bt & 130023424) === 0 && (bt = 4194304)));
  var t = le();
  ...
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || se.current) oe = !0;
      ...
      if ((e.lanes & t) === 0 && (n.flags & 128) === 0)
        return ((oe = !1), ac(e, n, t));
      oe = (e.flags & 131072) !== 0;
    }
  else ((oe = !1), I && (n.flags & 1048576) !== 0 && Es(n, Rr, n.index));
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Ou(n, t | 1), fe(n, Q()), (L & 6) === 0 && ((et = Q() + 500), dn()));
      }
      break;
    case 13:
      (Nn(function () {
...
Ao = si;
Bo = Nn;
var Tc = { usingClientEntryPoint: !1, Events: [$t, Fn, Gr, Uo, Vo, si] },
  dt = {
  ...
  Lc = {
    ...
    findFiberByHostInstance: dt.findFiberByHostInstance || zc,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!fr.isDisabled && fr.supportsFiber)
    try {
      (($r = fr.inject(Lc)), (Oe = fr));
    } catch {}
}
ve.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Tc;
